...
export default function Home(props) {
  ...
  return (
    <>
      <Head>
        <title>Doge AI</title>
        <meta name="description" content="Generated by Doge AI" />
            ...
            <ScrollTrigger onEnter={onEnterBox} onExit={onExitBox}>
              ...
              >
                <div className={`box_container p-3 p-lg-4 `}>
                  ...
                  >
                    35% of DogeAI supply will be airdropped to starknet users.
                    You can claim DogeAI tokens after starknet airdrop.
                  </p>
                  <br />
